...
const styles = {
  ...
  padding: 28,
  background:
    "radial-gradient(900px 600px at 20% 10%, rgba(34,197,94,0.28), transparent 55%)," +
    "radial-gradient(850px 560px at 80% 0%, rgba(134,239,172,0.35), transparent 55%)," +
    "radial-gradient(900px 700px at 50% 100%, rgba(187,247,208,0.45), transparent 60%)," +
